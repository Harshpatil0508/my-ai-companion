...
const statIcons = [
  { key: "mood_score", label: "Mood", icon: Sparkles, suffix: "/10", color: "text-primary", gradient: "from-primary/20 to-primary/5" },
  { key: "sleep_hours", label: "Sleep", icon: Moon, suffix: "h", color: "text-accent", gradient: "from-accent/20 to-accent/5" },
  { key: "work_hours", label: "Work", icon: Briefcase, suffix: "h", color: "text-primary", gradient: "from-primary/20 to-primary/5" },
  { key: "goal_completed_percentage", label: "Goals", icon: Target, suffix: "%", color: "text-accent", gradient: "from-accent/20 to-accent/5" },
];
    ...
    <DashboardLayout>
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-5">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                {hasLogToday
                  ? "Consistency beats motivation. You're building momentum — keep the streak alive."
                  : "Log today to unlock personalized insights."}
              </p>

              <Button variant="ghost" size="sm" className="mt-4 text-primary font-medium -ml-2" asChild>
                <Link to="/insights">
          ...
          >
            <h2 className="font-display font-semibold mb-4">7-Day Mood Trend</h2>
              ...
              <ResponsiveContainer width="100%" height={110}>
                ...
                >
                  <Line
                    ...
                    strokeWidth={2.5}
                    dot={{ r: 3, fill: "hsl(210, 100%, 56%)", strokeWidth: 0 }}
                    activeDot={{ r: 5, fill: "hsl(210, 100%, 56%)", strokeWidth: 2, stroke: "hsl(228, 12%, 4%)" }}
                  />
                  <Tooltip
                    contentStyle={{
